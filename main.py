...
class Main(tk.Frame):
    ...
    def init_main(self): # Метод со всеми графическими элементами(поля,кнопки)
        ...
        toolbar = tk.Frame(bg="#d7d7d7", bd=2)              # Установили цвет фона рамки и ширину рамки
        ...
        btn_open_dialog = tk.Button(
            toolbar, bg="#d7d7d7", bd=0, image=self.add_img, command=self.open_dialog
        )
...
class DB:
    ...
    def data(self):
        ...
        user_data=('Michael', '+19884566655', 'michael@gmail.com','120')
        user_data1=('James', '+798233123655', 'james@gmail.com','120')
        user_data2=('Jhon', '+19895646655', 'jhon@yandex.com','120')
        user_data3=('Jackob', '+79885423054', 'jackob@gmail.com','120')
        user_data4=('Fedor', '89212335532', 'fedor@yandex.com','120')
...
if __name__ == "__main__":
    ...
    root.geometry("645x450")                        # Установили размер экземпляра Tk
